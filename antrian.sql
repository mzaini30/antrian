...
--
-- Table structure for table `antrian_titip`
--

DROP TABLE IF EXISTS `antrian_titip`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `antrian_titip` (
...
--
-- Dumping data for table `antrian_titip`
--

LOCK TABLES `antrian_titip` WRITE;
/*!40000 ALTER TABLE `antrian_titip` DISABLE KEYS */;
/*!40000 ALTER TABLE `antrian_titip` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `titip` (
  ...
  `foto_ktp_asli` varchar(200) NOT NULL,
...
LOCK TABLES `titip` WRITE;
/*!40000 ALTER TABLE `titip` DISABLE KEYS */;
/*!40000 ALTER TABLE `titip` ENABLE KEYS */;
UNLOCK TABLES;
